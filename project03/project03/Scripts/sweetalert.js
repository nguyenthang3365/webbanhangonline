...
!(function (t, e) {
    ...
    var b = {},
        ...
        B = function (e) {
            console.warn(
                "".concat(k, " ").concat("object" === t(e) ? e.join(" ") : e)
            );
        },
        P = function (t) {
    ...
    var Ot = { innerParams: new WeakMap(), domCache: new WeakMap() },
                ...
                if (Rt[t.input]) {
                    ...
                    P(
                        "Unexpected type of input! Expected "
                            .concat(Object.keys(Rt).join(" | "), ', got "')
                            .concat(t.input, '"')
                    );
        },
        Mt = function (t, e) {
        ...
        Rt = {};
    (Rt.text = Rt.email = Rt.password = Rt.number = Rt.tel = Rt.url = Rt.search = Rt.date = Rt[
        "datetime-local"
    ] = Rt.time = Rt.week = Rt.month = function (t, e) {
                        ...
                        o(f, [
                            {
                                key: "_main",
                                value: function (e, n) {
                                    return s(i(f.prototype), "_main", this).call(
                                        this,
                                        e,
                                        Object.assign({}, t, n)
                                    );
